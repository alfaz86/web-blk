...
class CheckIfAdmin extends AuthenticateSession
{
    /**
     * Checked that the logAuthenticateSessionr is an administrator.
     *
     * --------------
     * VERY IMPORTANT
     * --------------
    ...
    private function respondToUnauthorizedRequest($request)
    {
        if ($request->ajax() || $request->wantsJson()) {
            ...
            \Alert::error('Incorrect email or password.')->flash();
