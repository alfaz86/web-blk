        ...
        <div class="row align-items-center">
            <div class="col-lg-5 mb-5 mb-lg-0">
                <div class="bg-light d-flex flex-column justify-content-center px-5" style="height: 450px;">
                    ...
                    <div class="d-flex align-items-center text-break">
                        ...
                        <div class="mt-n1">
                            <h4>Email Us</h4>
                            <p class="m-0">blkponpesdarulfalah@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-7">
                <div class="section-title position-relative mb-4">
                    <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Perlu Bantuan?</h6>
                    <h1 class="display-4">Kirimkan pesan pada kami</h1>
                </div>
